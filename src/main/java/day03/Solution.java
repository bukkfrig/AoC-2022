...
public interface Solution {
     ...
     * 
     * <p>
     * Each rucksack has two large <strong>compartments</strong>. All items of a
     * given type are meant to go into exactly one of the two compartments. The Elf
     * that did the packing failed to follow this rule for exactly one item type per
     * rucksack.
     * 
     * <p>
     ...
     * 
     * <ul>
     * <li>The first rucksack contains the items vJrwpWtwJgWrhcsFMMfFFhFp, which
     ...
     * <li>The second rucksack's compartments contain jqHRNqRjqzjGDLGL and
     * rsFMfFZSrLrFZsSL. The only item type that appears in both compartments is
     * uppercase L.
     * <li>The third rucksack's compartments contain PmmdzqPrV and vPwwTWBwg; the
     * only common item type is uppercase P.
     * <li>The fourth rucksack's compartments only share item type v.
     * <li>The fifth rucksack's compartments only share item type t.
     * <li>The sixth rucksack's compartments only share item type s.
     * </ul>
     * 
     * <p>
     ...
     * <strong>What is the sum of the priorities of those item types?</strong>
     */
     ...
     * Elves, the badge is the <strong>only item type carried by all three
     * Elves</strong>. That is, if a group's badge is item type B, then all three
     * Elves will have item type B somewhere in their rucksack, and at most two of
     ...
     * the one item type that is <strong>common between all three Elves</strong> in
     * each group.
     * 
     * <p>
