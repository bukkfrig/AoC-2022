...
public interface Solution {
     ...
     * strategy guide</strong> (your puzzle input) that they say will be sure to
     * help you win. "The first column is what your opponent is going to play: A for
     * Rock, B for Paper, and C for Scissors. The second column--" Suddenly, the Elf
     ...
     * <strong>total score</strong> is the sum of your scores for each round. The
     * score for a single round is the score for the <strong>shape you
     * selected</strong> (1 for Rock, 2 for Paper, and 3 for Scissors) plus the
     * score for the <strong>outcome of the round</strong> (0 if you lost, 3 if the
     ...
     * <li>The third round is a draw with both players choosing Scissors, giving you
     * a score of 3 + 3 = 6.
     * </ul>
     * 
     * <p>
     ...
     * 
     * <p>
     * <strong>What would your total score be if everything goes exactly according
     * to your strategy guide?</strong>
     */
     ...
     * <li>In the third round, you will defeat your opponent's Scissors with Rock
     ...
     * 
     * <p>
     * Following the Elf's instructions for the second column, <strong>what would
